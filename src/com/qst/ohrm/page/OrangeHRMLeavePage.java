...
//	WebElement pagetitle;
	...
	public void moveMouseOnLeaveConfigureMenu(){
		...
		DriverUtils.getVisibleElement(driver, leaveType);
		Assert.assertTrue(leaveType.isDisplayed());
		leaveType.click();
		leaveTypeAddBtn.click();
		leaveTypeName.sendKeys("Leave Type1");
		leaveTypeSaveBtn.click();
		
	}
	
	public void clickOnleaveType(){
		Log.info("---clicking on leave type---");
