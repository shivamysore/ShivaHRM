...
public class ExtentReportFactory {
	...
	public static void sendReportByGMail(String... to) throws EmailException 
	{
		EmailAttachment attachment = new EmailAttachment();
		  ...
		  if(to.length==0)
		  {
			  email.addTo("shiavprasadks46@gmail.com");
			  
		  }else
		  {
			  email.addTo(to); 
		  }
		   email.setAuthenticator(new DefaultAuthenticator("shivaprasadks46@gmail.com", "shiva@321"));
		  email.setSSLOnConnect(true);
		  email.setFrom("shivaprasadks46@gmail.com", "QSP-OrangeHRM Automation Team");
		  email.setSubject("Automation Test Execution Report for Orange HRM");
